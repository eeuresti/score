...
;(function ($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		showPane: function(index) {
		    ...
		    var li_count = $("#tinerslide > ul > li").length
		            ...
		            $.ajax({
		                ...
		                success: function(e) {
		                  $(."spinner").hide(); // Do something on success!
								...
								//panes.eq(current_pane).attr("id");
		            var last_id = $("tinerslide > ul > li").first().attr("id")
								// make an ajax call passing aling our last user id
		            $.ajax({
										//make a get request to the server
		                type: "GET",
										// get the url from the href attribute of our link
